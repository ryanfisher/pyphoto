...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.optimized_key'
        db.add_column(u'photos_photo', 'optimized_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Photo.thumbnail_key'
        db.add_column(u'photos_photo', 'thumbnail_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


        # Changing field 'Photo.key'
        db.alter_column(u'photos_photo', 'key', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'Photo.optimized_key'
        db.delete_column(u'photos_photo', 'optimized_key')

        # Deleting field 'Photo.thumbnail_key'
        db.delete_column(u'photos_photo', 'thumbnail_key')


        # Changing field 'Photo.key'
        db.alter_column(u'photos_photo', 'key', self.gf('django.db.models.fields.CharField')(max_length=128))
