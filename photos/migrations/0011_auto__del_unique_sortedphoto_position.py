...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SortedPhoto', fields ['position']
        db.delete_unique(u'photos_sortedphoto', ['position'])


    def backwards(self, orm):
        # Adding unique constraint on 'SortedPhoto', fields ['position']
        db.create_unique(u'photos_sortedphoto', ['position'])
