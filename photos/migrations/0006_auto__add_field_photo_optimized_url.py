...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.optimized_url'
        db.add_column(u'photos_photo', 'optimized_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.optimized_url'
        db.delete_column(u'photos_photo', 'optimized_url')
