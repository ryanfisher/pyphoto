...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.key'
        db.add_column(u'photos_photo', 'key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


        # Changing field 'Photo.size'
        db.alter_column(u'photos_photo', 'size', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Deleting field 'Photo.key'
        db.delete_column(u'photos_photo', 'key')


        # Changing field 'Photo.size'
        db.alter_column(u'photos_photo', 'size', self.gf('django.db.models.fields.FloatField')())
